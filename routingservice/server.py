...
# The following is the backend processor service.
# It receives a message from the frontend (nodes A and B) and returns the result,
# i.e. the shortest path between the requested nodes.
